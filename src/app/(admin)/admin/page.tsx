...
async function getDashboardData() {
  ...
  const [
    ...
    prisma.customOrder.count({ where: { status: 'received' as const, deletedAt: null } }).catch(() => 0),
    prisma.customOrder.count({ where: { status: { in: ['analyzing', 'negotiating', 'approved', 'purchasing'] as const }, deletedAt: null } }).catch(() => 0),
